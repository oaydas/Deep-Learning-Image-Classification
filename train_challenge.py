...
def train(
    ...
    epoch = start_epoch
    while curr_patience < patience and epoch < 30:
        # Train model
    ...
    plt.savefig(f"challenge_training_plot_frozen_layers={num_layers}.png", dpi=200)
...
def main() -> None:
    ...
    train(tr_loader, va_loader, te_loader, freeze_three, config("challenge.checkpoint"), 3)
